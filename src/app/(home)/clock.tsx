...
export default function Page() {
  ...
  //         return setSystemBrightnessAsync(1)
  ...
  return (
    <View>
      ...
      >
        ...
        >
          <Text className='text-gray-200 text-[156px] font-minecraft -mb-24'>
            {hour}
          </Text>
          <Text className='text-gray-200 text-[156px] -my-2 -ml-1 font-minecraft'>
            . .
          </Text>
          <Text className='text-gray-200 text-[156px] font-minecraft'>
            {minutes}
          </Text>
          {/* <BlurView
            tint="dark"
